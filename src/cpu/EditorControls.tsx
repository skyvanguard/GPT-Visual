...
export const CpuEditorToolbar: React.FC<{}> = () => {
    ...
    return <div className={clsx(s.toolsTopLeft, s.toolbar, "flex items-stretch")}>
        <button className={s.toolbarBtn} onClick={undo} disabled={!undoAvailable}>Deshacer</button>
        <button className={s.toolbarBtn} onClick={redo} disabled={!redoAvailable}>Rehacer</button>
