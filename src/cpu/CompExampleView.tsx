...
export const CompExampleView: React.FC = () => {
    ...
    return <div className={s.exampleView}>
        <div className={s.header}>Ejemplos
        ...
        <div className={s.body}>
            <button className={s.btn} disabled={exeModel.runArgs.halt} onClick={onStepClicked}>Paso</button>
            <button className={s.btn} onClick={onResetClicked}>Reiniciar</button>
            <button className={s.btn} onClick={onRunAllTestsClicked}>Ejecutar todo</button>
            <button className={s.btn} onClick={runTestsQuickly}>Ejecutar todo (lento)</button>
        </div>
