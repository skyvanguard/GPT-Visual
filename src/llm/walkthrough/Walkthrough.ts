...
import { walkthrough10_Training } from "./Walkthrough10_Training";
...
export function initWalkthrough() {
    return {
        ...
        phaseList: [{
            ...
            title: 'Introducción',
            phases: [
                { id: Phase.Intro_Intro, title: 'Descripción General' },
                { id: Phase.Intro_Prelim, title: 'Preliminares' },
            ],
        }, {
            ...
            phases: [
                ...
                { id: Phase.Input_Detail_LayerNorm, title: 'Norm. Capa' },
                { id: Phase.Input_Detail_SelfAttention, title: 'Auto-Atención' },
                { id: Phase.Input_Detail_Projection, title: 'Proyección' },
                ...
                { id: Phase.Input_Detail_Output, title: 'Salida' },
            ],
        }, {
            groupId: PhaseGroup.Training,
            title: 'Entrenamiento',
            phases: [
                { id: Phase.Training_Overview, title: 'Cómo Aprende' },
            ],
        }] as IPhaseGroup[],
    };
}
...
export function runWalkthrough(state: IProgramState, view: IRenderView) {
    ...
    } else if (groupId === PhaseGroup.Training) {
        walkthrough10_Training(wtArgs);
    }
