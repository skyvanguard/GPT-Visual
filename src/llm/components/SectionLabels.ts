...
export function drawBlockLabels(state: IRenderState, layout: IGptModelLayout) {
    ...
    for (let block of layout.blocks) {
...

        {
            ...
            drawSectionLabel(state, `Auto-atención`, tl, br, { color, fontSize: 12 });
        }
...

        {
            ...
            drawSectionLabel(state, `Proyección`, tl, br, { color, fontSize: 10 });
        }
        ...
        for (let head of block.heads) {

            {
                ...
                drawSectionLabel(state, `Cabeza ${headIdx}`, tl, br, { color, fontSize: 10 });
            }
